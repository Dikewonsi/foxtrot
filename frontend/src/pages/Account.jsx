...
export default function AccountPageModern() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 md:flex md:pt-20 pt-11">
      ...
      <main className="flex-1 mx-auto max-w-5xl px-4 md:px-8 py-6">
        ...
        <div className="sticky top-4 z-40">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white text-lg font-bold">FM</div>
              <div>
        ...
        <motion.section initial="hidden" animate="show" variants={container} className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          <motion.div variants={fadeUp} whileHover={float.hover} className="lg:col-span-2 p-6 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg">
